...
//Перетворення введеного в задачі 19-20 в стрічку
function getAnswer(theObject1, theObject2, theObject3, theObject4, theObject5, theObject6, theObject7) {
    var strAnsw = '';
    strAnsw = document.getElementById(theObject1).value + document.getElementById(theObject2).value + document.getElementById(theObject3).value + document.getElementById(theObject4).value + document.getElementById(theObject5).value + document.getElementById(theObject6).value + document.getElementById(theObject7).value;
    return strAnsw
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form').onsubmit = () => {
        ...
        if (getAnswer('z19-1', 'z19-2', 'z19-3', 'z19-4', 'z19-5', 'z19-6', 'z19-7') != "") {
            check_radio++;
        }
        if (getAnswer('z20-1', 'z20-2', 'z20-3', 'z20-4', 'z20-5', 'z20-6', 'z20-7') != "") {
            check_radio++;
        }
